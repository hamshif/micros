package com.wielder.micros.eve;
...
public class EveApplication {
    ...
    private static final Logger log = LoggerFactory.getLogger(EveApplication.class);
    ...
    public StreamsBuilder streamsBuilder( //
                                  TopicNameExtractor<String, String>  telegrafMetricTimestampExtractor, //
...
//                .print(Printed.toSysOut());
                .to("demo", Produced.with(Serdes.String(), Serdes.String()));
